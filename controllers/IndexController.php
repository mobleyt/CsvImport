...
class CsvImport_IndexController extends Omeka_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        if ($form->getValue('omeka_csv_export') || ($form->getValue('record_type_id') == 1)) {
    ...
    /**
     * For import of Omeka.net CSV. Checks if the user didn't read the manual
     * and so didn't make sure all needed Elements are present.
     */
    ...
    public function omekaCsvAction()
    {
        ...
        //
        // @TODO: check if variable itemTypes and Collections breaks undo. It
    ...
    private function _getNavigation()
    {
        return new Zend_Navigation(array(
            array(
                'label' => 'Import items and metadata',
                'action' => 'index',
                'module' => 'csv-import',
            ),
            array(
